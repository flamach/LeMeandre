...
window.MEANDRE_UI = {
  fr: {
    ...
    menuBistrotTitle: "L'Esprit Bistrot", menuBistrotSub: 'Plat du jour · Boisson café', menuBistrotNote: 'Du lundi au vendredi midi uniquement, hors jours fériés',
    menuTerroirTitle: "L'Esprit du Méandre", menuTerroirSub: 'Entrée · Plat · Dessert',
    menuEstreeTitle: 'La Signature du Méandre', menuEstreeSub: 'Entrée · Plat · Fromage ou Dessert',
    galleryEyebrow: 'EN IMAGES', galleryTitle: "La table, la salle, l'ambiance",
    hoursEyebrow: 'HORAIRES', hoursText: 'Du lundi au dimanche', hoursLunch: 'Déjeuner · 12h00 – 13h30', hoursDinner: 'Dîner · 19h30 – 21h30', hoursClosed: 'Fermé le dimanche soir',
    ...
    practice3Title: 'Linge fourni', practice3Text: 'Peignoirs et serviettes à disposition',
  ...
  en: {
    ...
    menuBistrotTitle: 'The Bistro Spirit', menuBistrotSub: 'Dish of the day · Coffee drink', menuBistrotNote: 'Monday to Friday lunch only, excluding public holidays',
    menuTerroirTitle: 'The Méandre Spirit', menuTerroirSub: 'Starter · Main · Dessert',
    menuEstreeTitle: 'The Méandre Signature', menuEstreeSub: 'Starter · Main · Cheese or Dessert',
    galleryEyebrow: 'GALLERY', galleryTitle: 'The table, the room, the atmosphere',
    hoursEyebrow: 'HOURS', hoursText: 'Monday to Sunday', hoursLunch: 'Lunch · 12:00 – 1:30 PM', hoursDinner: 'Dinner · 7:30 – 9:30 PM', hoursClosed: 'Closed Sunday evening',
    ...
    practice3Title: 'Linens provided', practice3Text: 'Robes and towels provided',
  ...
  de: {
    ...
    menuBistrotTitle: 'Der Bistro-Geist', menuBistrotSub: 'Tagesgericht · Kaffeegetränk', menuBistrotNote: 'Montag bis Freitag, nur mittags, außer an Feiertagen',
    menuTerroirTitle: 'Der Geist des Méandre', menuTerroirSub: 'Vorspeise · Hauptgang · Dessert',
    menuEstreeTitle: 'Die Signatur des Méandre', menuEstreeSub: 'Vorspeise · Hauptgang · Käse oder Dessert',
    galleryEyebrow: 'BILDER', galleryTitle: 'Die Tafel, der Saal, die Atmosphäre',
    hoursEyebrow: 'ÖFFNUNGSZEITEN', hoursText: 'Montag bis Sonntag', hoursLunch: 'Mittagessen · 12:00 – 13:30 Uhr', hoursDinner: 'Abendessen · 19:30 – 21:30 Uhr', hoursClosed: 'Sonntagabend geschlossen',
    ...
    practice3Title: 'Wäsche gestellt', practice3Text: 'Bademäntel und Handtücher stehen zur Verfügung',
  ...
  es: {
    ...
    menuBistrotTitle: 'El Espíritu Bistrot', menuBistrotSub: 'Plato del día · Bebida café', menuBistrotNote: 'De lunes a viernes, solo al mediodía, excepto festivos',
    menuTerroirTitle: 'El Espíritu del Méandre', menuTerroirSub: 'Entrante · Plato · Postre',
    menuEstreeTitle: 'La Signature del Méandre', menuEstreeSub: 'Entrante · Plato · Queso o Postre',
    galleryEyebrow: 'GALERÍA', galleryTitle: 'La mesa, la sala, el ambiente',
    hoursEyebrow: 'HORARIOS', hoursText: 'De lunes a domingo', hoursLunch: 'Comida · 12:00 – 13:30 h', hoursDinner: 'Cena · 19:30 – 21:30 h', hoursClosed: 'Cerrado domingo por la noche',
    ...
    practice3Title: 'Ropa de baño incluida', practice3Text: 'Albornoces y toallas a su disposición',
  ...
  nl: {
    ...
    menuBistrotTitle: 'De Bistro Geest', menuBistrotSub: 'Dagschotel · Koffie', menuBistrotNote: "Maandag tot en met vrijdag, alleen 's middags, behalve feestdagen",
    menuTerroirTitle: 'De Geest van de Méandre', menuTerroirSub: 'Voorgerecht · Hoofdgerecht · Dessert',
    menuEstreeTitle: 'De Signature van de Méandre', menuEstreeSub: 'Voorgerecht · Hoofdgerecht · Kaas of Dessert',
    galleryEyebrow: 'IN BEELD', galleryTitle: 'De tafel, de zaal, de sfeer',
    hoursEyebrow: 'OPENINGSTIJDEN', hoursText: 'Maandag tot en met zondag', hoursLunch: 'Lunch · 12:00 – 13:30 uur', hoursDinner: 'Diner · 19:30 – 21:30 uur', hoursClosed: 'Gesloten op zondagavond',
    ...
    practice3Title: 'Linnengoed inbegrepen', practice3Text: 'Badjassen en handdoeken ter beschikking',
